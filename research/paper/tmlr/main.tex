...
\title{Externalizing the Workspace:\\Persistent Self-State for Long-Horizon Agent Coherence}
\author{\name Wang Bihao (Oratis) \email oratiswang@gmail.com \\
        \addr HakkoLab}
...
\midrule
Full (soul $+$ broadcast) & 1.00 [1.00,1.00] & \textbf{0.95 [0.87,1.00]} & 1.00 [1.00,1.00] \\
