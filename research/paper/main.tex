...
\item \textbf{The metric demonstrated end-to-end} (\S\ref{sec:e6}): on controlled LISA-style contexts, soul injection raises mid-band workspace occupancy of the soul's identity concepts (control battery unmoved), occupancy decays under context dilution and is restored by re-broadcast, and occupancy correlates with soul-consistent behavior --- a micro-scale pilot of the mechanism the pre-registered study will test longitudinally. A cross-family replication accompanies it.
